...
INSERT INTO `contacts` VALUES (16,'Model 2 ','3475002709','',34),(17,'Model 1 ','+1 (929) 306-8247','',34),(18,'Херопрактор От Виктора Галины сын','3476663456','Записаться ',34),(20,'Tatiana Miami','1 3059512580','Tatiana Miami Lazer',34),(21,'Cndela Lazer','929 280 58 43','Laser associate',34),(23,'Mike Regina   Ultherapy','516 864 1389','',34),(24,'14B Michel','9176791516','Tennis',34),(25,'Pain Manager from Alexey 14E','7189989890','',34),(26,'Stomatologist','(718) 416-6364','2952 Brighton 3rd St suite 501, Brooklyn, NY 11235',34);
...
--
-- Table structure for table `myapp_sleeplog`
--

DROP TABLE IF EXISTS `myapp_sleeplog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `myapp_sleeplog` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
  `sleep_time` datetime(6) NOT NULL,
...
--
-- Dumping data for table `myapp_sleeplog`
--

LOCK TABLES `myapp_sleeplog` WRITE;
/*!40000 ALTER TABLE `myapp_sleeplog` DISABLE KEYS */;
/*!40000 ALTER TABLE `myapp_sleeplog` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `users` VALUES (34,'Vlad','Pritzkervlad@gmail.com','pbkdf2_sha256$720000$LPVqXqrl9NvfW2B88JeX7H$uCs9YLL2cMEgzutRyasn+g9EZiv/jYefHEpkvxQNW+E=',0.00,19526.50,136375.00,'2024-04-30 11:20:48',1,0,0,200000.00,318.00,900.00,24463.50,'user_34/2024-04-25 19.11.33.jpg',14260.00,15278.00,24352.00),(36,'Vlad','Test@gmail.com','pbkdf2_sha256$720000$2KlPXI8MABHwG8MymwmnKb$l1ZW/4StzB+qcjE2wmx8yPY12mMwmdrKuk+yT47nInQ=',970750.00,3175.00,514173.00,'2024-05-01 12:29:21',1,0,1,1000000.00,77.00,77.00,3242.00,'user_36/2024-04-25 19.11.33.jpg',0.00,0.00,44600.00);
...
-- Dump completed on 2024-07-08 11:48:37
