...
print("Select a template for the envelope:")
print("1: Template ID 1 (17cc51e1-5433-4576-98bb-7c60bde50bbd)")
print("2: Template ID 2 (fc1fa3af-f87d-4558-aa10-6b275852c78e)")
template_choice = input("Enter 1 or 2 to select the template: ")
...
if template_choice == "1":
    ...
    raise ValueError("Invalid selection. Please select 1 or 2.")
